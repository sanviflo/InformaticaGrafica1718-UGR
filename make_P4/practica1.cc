...
void idle(){
	if(escena->getTecla()!='1' && escena->getTecla()!='2' && escena->getTecla()!='3' && escena->getTecla()!='+' && escena->getTecla()!='-' && escena->getTecla()!='*'){
		escena->modifica();
		glutPostRedisplay();	
	}
}
...
glutCreateWindow("Práctica 1: Santiago Vidal Martínez");
